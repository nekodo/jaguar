...
var mergeSet = function(xs){return function(ys){return (function(){var $pm = (length)(xs);return ((0)==($pm))?((function(){return ys})()):((true)?((function(lx){return (function(){var $pm = (length)(ys);return ((0)==($pm))?((function(){return xs})()):((true)?((function(ly){return (function(){var $pm = (($lt)((head)(xs)))((head)(ys));return ($pm)?((function(){return ((enqueue)((head)(xs)))(((mergeSet)((tail)(xs)))(ys))})()):((!($pm))?((function(){return (function(){var $pm = (($eq)((head)(xs)))((head)(ys));return ($pm)?((function(){return ((enqueue)((head)(xs)))(((mergeSet)((tail)(xs)))((tail)(ys)))})()):((!($pm))?((function(){return ((enqueue)((head)(ys)))(((mergeSet)(xs))((tail)(ys)))})()):((error)("pattern match fail")))})()})()):((error)("pattern match fail")))})()})($pm)):((error)("pattern match fail")))})()})($pm)):((error)("pattern match fail")))})()}};
...
var importToJs = function(importSymbols){return function(freeVars){return function(i){return (function(){var $pm = i;return (((($pm) instanceof ($ImportClosed))&&(true))&&(true))?((function(f,n){return (function(){var $pm = ((contains)(n))(freeVars);return ($pm)?((function(){return (arr1)(((JSVar)(n))((requireExpr)(f)))})()):((!($pm))?((function(){return emptyArray})()):((error)("pattern match fail")))})()})(($pm)["$0"],($pm)["$1"])):((((($pm) instanceof ($ImportOpen))&&(true))&&(true))?((function(f,ns){return ((buildImports)(f))(((filter)(function(n){return ((contains)(n))(freeVars)}))(ns))})(($pm)["$0"],($pm)["$1"])):(((($pm) instanceof ($ImportAll))&&(true))?((function(f){return ((buildImports)(f))(((filter)(function(n){return ((contains)(n))(freeVars)}))(((get)(f))(importSymbols)))})(($pm)["$0"])):((error)("pattern match fail"))))})()}}};
...
var moduleToJs = function(importSymbols){return function(m){return (function(){var $pm = m;return ((((($pm) instanceof ($Module))&&(true))&&(true))&&(true))?((function(is,ds,vs){return ((push)(((JSVar)("exports"))(((exportObject)(ds))(vs))))(((concat)(((concatMap)(((importToJs)(importSymbols))((freeVarsInModule)(m))))(((enqueue)((ImportAll)("../builtins.js")))(is))))(((concat)(((concatMap)(dataToJs))(ds)))(((map)(defToJs))(vs))))})(($pm)["$0"],($pm)["$1"],($pm)["$2"])):((error)("pattern match fail"))})()}};
var opName = function(op){return (function(){var $pm = op;return (("+")==($pm))?((function(){return "$add"})()):((("-")==($pm))?((function(){return "$del"})()):((("*")==($pm))?((function(){return "$mul"})()):((("<")==($pm))?((function(){return "$lt"})()):(((">")==($pm))?((function(){return "$gt"})()):((("==")==($pm))?((function(){return "$eq"})()):((("/=")==($pm))?((function(){return "$neq"})()):((("&&")==($pm))?((function(){return "$and"})()):((("||")==($pm))?((function(){return "$or"})()):((("++")==($pm))?((function(){return "$concat"})()):((true)?((function(nonOp){return nonOp})($pm)):((error)("pattern match fail"))))))))))))})()};
var freeVarsInModule = function(m){return (function(){var $pm = m;return ((((($pm) instanceof ($Module))&&(true))&&(true))&&(true))?((function(is,ds,vs){return ((map)(opName))((((foldl)(mergeSet))(emptyArray))(((map)(function(p){return (freeVarsInExpr)((snd)(p))}))(vs)))})(($pm)["$0"],($pm)["$1"],($pm)["$2"])):((error)("pattern match fail"))})()};
var freeVarsInExpr = function(e){return (function(){var $pm = e;return ((($pm) instanceof ($Var))&&(true))?((function(v){return (arr1)(v)})(($pm)["$0"])):(((($pm) instanceof ($Const))&&(true))?((function(c){return emptyArray})(($pm)["$0"])):((((($pm) instanceof ($App))&&(true))&&(true))?((function(f,x){return ((mergeSet)((freeVarsInExpr)(f)))((freeVarsInExpr)(x))})(($pm)["$0"],($pm)["$1"])):((((($pm) instanceof ($Lam))&&(true))&&(true))?((function(p,b){return ((filter)(function(v){return (($neq)(v))(p)}))((freeVarsInExpr)(b))})(($pm)["$0"],($pm)["$1"])):((((($pm) instanceof ($Case))&&(true))&&(true))?((function(e,ps){return (((foldl)(mergeSet))((freeVarsInExpr)(e)))(((map)(freeVarsInPat))(ps))})(($pm)["$0"],($pm)["$1"])):((error)("pattern match fail"))))))})()};
var freeVarsInPat = function(p){return (function(){var $pm = p;return (((($pm) instanceof ($Pair))&&(true))&&(true))?((function(pat,e){return ((mergeSet)(((filter)(function(v){return (not)(((contains)(v))((namesInPat)(pat)))}))((freeVarsInExpr)(e))))((freeVarsInPData)(pat))})(($pm)["$0"],($pm)["$1"])):((error)("pattern match fail"))})()};
var freeVarsInPData = function(p){return (function(){var $pm = p;return (((($pm) instanceof ($PData))&&(true))&&(true))?((function(n,ps){return (((foldl)(mergeSet))((arr1)((($concat)("$"))(n))))(((map)(freeVarsInPData))(ps))})(($pm)["$0"],($pm)["$1"])):((true)?((function(p){return emptyArray})($pm)):((error)("pattern match fail")))})()};
var namesInPat = function(p){return (function(){var $pm = p;return ((($pm) instanceof ($PVar))&&(true))?((function(v){return (arr1)(v)})(($pm)["$0"])):(((($pm) instanceof ($PConst))&&(true))?((function(c){return emptyArray})(($pm)["$0"])):((((($pm) instanceof ($PData))&&(true))&&(true))?((function(n,ps){return (((foldl)(mergeSet))(emptyArray))(((map)(namesInPat))(ps))})(($pm)["$0"],($pm)["$1"])):((error)("pattern match fail"))))})()};
...
var exports = {jsExprToString:jsExprToString,keyValueToString:keyValueToString,jsStmtToString:jsStmtToString,caseToString:caseToString,paren:paren}
return exports;})();
...
var compileModule = function(importSymbols){return function(m){return ((join)(((map)(jsStmtToString))(((moduleToJs)(importSymbols))(m))))(";\n")}};
...
var transpileExpr = function(s){return (function(){var $pm = (parseExpr)(s);return (((($pm) instanceof ($Success))&&(true))&&(true))?((function(e,ps){return (compileExpr)(e)})(($pm)["$0"],($pm)["$1"])):((true)?((function(e){return (error)(e)})($pm)):((error)("pattern match fail")))})()};
var transpileModule = function(importSymbols){return function(s){return (function(){var $pm = (parseModule)(s);return (((($pm) instanceof ($Success))&&(true))&&(true))?((function(m,ps){return ((compileModule)(importSymbols))(m)})(($pm)["$0"],($pm)["$1"])):((true)?((function(e){return (error)(e)})($pm)):((error)("pattern match fail")))})()}};
