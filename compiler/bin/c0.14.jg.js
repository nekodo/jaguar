...
return (function(){
var builtinsPath = (getIx(2))(argv);var mainName = ($concat("//"))((getIx(4))(argv));var srcFiles = (slice(4))(argv);var srcs = ((foldl(function(ss){
return function(s){
return ((set(($concat("//"))(s)))(readFile(s)))(ss)}}))(empty))(srcFiles);var compiled = (mapRecord(compile))(srcs);var imports = (mapRecord(findImports))(compiled);var imports2 = debug(imports);var ordered = ((dfs(imports2))(emptyArray))(mainName);var ordered2 = debug(ordered);var builtinsExports = loadJSExports(builtinsPath);var exports = ((set("./builtins.js"))(parseExports(builtinsExports)))(empty);var toJs = function(er){
return function(n){
return (function(){
var $pm = er;return ($pm.$tag==Pair.$tag)?((function(exports,result){
return (function(){
var m = (get(n))(compiled);var typed = (inferTypeModule(exports))(m);var transpiled = (compileModule(exports))(typed);var e = getTypedExports(typed);return (Pair(((set(n))(e))(exports)))((push((Pair(n))(transpiled)))(result))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}};var jsms = snd(((foldr(toJs))((Pair(exports))(emptyArray)))(ordered2));var js = ((combineModules(mainName))(builtinsPath))(jsms);var outPath = (getIx(3))(argv);return (writeFile(js))(outPath)})()};
var depthFirstSearch = function(g){
return function(v){
return reverse(((dfs(g))(emptyArray))(v))}};
...
return error(e)})($pm))})()};
var exports = {compile:compile,findImports:findImports,parseT:parseT,parseExports:parseExports,main:main,depthFirstSearch:depthFirstSearch,instrument:instrument,inferM:inferM,findExports:findExports,transpileModule:transpileModule,transpileExpr:transpileExpr}
