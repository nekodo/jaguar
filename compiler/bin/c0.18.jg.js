...
var $instance$Functor$2 = $class$Functor(function(f){
return function(e){
return (function(){
...
var exports = {Just:Just,Nothing:Nothing,Pair:Pair,Left:Left,Right:Right,$class$Functor:$class$Functor,$class$Applicative:$class$Applicative,fmap:fmap,pure:pure,$lt$mul$gt:$lt$mul$gt,$instance$Functor$0:$instance$Functor$0,$instance$Applicative$1:$instance$Applicative$1,$instance$Functor$2:$instance$Functor$2,snd:snd,loop:loop,strToArray:strToArray,toRecord:toRecord,reverse:reverse,tail:tail,head:head,uniq:uniq,mergeSet:mergeSet,arr1:arr1,arr2:arr2,arr3:arr3,arr4:arr4,init:init,last:last,concatMap:concatMap,zip:zip,zipWithIndex2:zipWithIndex2,zipWithIndex:zipWithIndex,join:join,exists:exists,containsChar:containsChar,find:find,contains:contains,not:not,either:either,splitEither:splitEither,fst:fst,justOr:justOr,maybe:maybe}
return exports;})();
...
var $import1$instance$Functor$2 = (_require("//compiler/prelude.jg")).$instance$Functor$2;
...
return error(($concat(($concat("no var "))(v)))(" in environment " + JSON.stringify(Object.keys(env.$0))))})()):($pm?((function(){
return (function(){
...
return cs})($pm.$1)):(error("pattern match fail"))})()}))(is)))))(ins);return (((((Module(ann))(is))(ts))(cs))(ins))(ds3)})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3,$pm.$4,$pm.$5)):(error("pattern match fail"))})()})()}};
...
return (Pair((instanceName(ix))(i)))(instanceToTypeBound(i))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}))(zipWithIndex(ins)));var classesAsData = (map(rewriteClassToData))(cs);var dt2 = (concat(dt))(classesAsData);var dataFuns = (concatMap(conTypes))(dt2);var classFuns = (concatMap(rewriteClassToFun))(cs);var instancesAsDefs = (map(function(p){
return (function(){
...
var exports = {Success:Success,Error:Error,Parser:Parser,upperCaseLetters:upperCaseLetters,letters:letters,digits:digits,opt:opt,manyIterate:manyIterate,many:many,and:and,apply:apply,precedes:precedes,sepBy1:sepBy1,many1:many1,or:or,succeeds:succeeds,between:between}
return exports;})();
