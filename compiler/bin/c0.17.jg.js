...
var $instance$Functor$1 = $class$Functor(function(f){
return function(e){
return (function(){
...
var exports = {Just:Just,Nothing:Nothing,Pair:Pair,Left:Left,Right:Right,$class$Functor:$class$Functor,fmap:fmap,$instance$Functor$0:$instance$Functor$0,$instance$Functor$1:$instance$Functor$1,snd:snd,loop:loop,strToArray:strToArray,toRecord:toRecord,reverse:reverse,tail:tail,head:head,uniq:uniq,mergeSet:mergeSet,arr1:arr1,arr2:arr2,arr3:arr3,arr4:arr4,init:init,last:last,concatMap:concatMap,zip:zip,zipWithIndex2:zipWithIndex2,zipWithIndex:zipWithIndex,join:join,exists:exists,containsChar:containsChar,find:find,contains:contains,not:not,either:either,splitEither:splitEither,fst:fst,justOr:justOr,maybe:maybe}
return exports;})();
...
var $import1$instance$Functor$1 = (_require("//compiler/prelude.jg")).$instance$Functor$1;
...
return (function(){
var args = (map(snd))(sort(bs));var name = (instanceName(ix))(i);return (Pair(name))(((foldl(App(emptyAnn)))((Var(emptyAnn))(className(n))))(args))})()})($pm.$1,$pm.$3)):(error("pattern match fail"))})()}};
...
return (map(fst))(bs)})($pm.$3)):(error("pattern match fail"))})()}))(cs));return (Pair((push(((ImportOpen(ann))(f))((concat(ns))((concat(nas))(cns)))))(is)))((concat(ibs))(nbs))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$1,$pm.$2)):(error("pattern match fail"))})()})($pm.$0,$pm.$1.$0,$pm.$1.$1,$pm.$1.$2)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}};
...
return (Pair(fst(d)))(((rewriteExpr(availableInstances))(env2))(snd(d)))}))(ds);var classesAsData = (map(rewriteClassToData))(cs);var is2 = fst(isi);return (((((Module(ann))(is2))((concat(dt))(classesAsData)))(cs))(ins))((concat(classFuns))((concat(instancesAsDefs))(ds2)))})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3,$pm.$4,$pm.$5)):(error("pattern match fail"))})()}};
var exports = {S:S,instanceNameFromBound:instanceNameFromBound,getEnv:getEnv,breakableDownAndUpWithEnv:breakableDownAndUpWithEnv,addPrefix:addPrefix,setEnv:setEnv,rewriteExpr:rewriteExpr,className:className,className2:className2,rewriteClassToFun:rewriteClassToFun,rewriteClassToData:rewriteClassToData,instanceName:instanceName,rewriteInstance:rewriteInstance,instanceNameFromImport:instanceNameFromImport,instanceName2:instanceName2,rewriteImportedBound:rewriteImportedBound,rewriteImportedInstances:rewriteImportedInstances,importsToTypeEnv:importsToTypeEnv,declassModule:declassModule}
return exports;})();
...
var opIdentP = (mkTok(IdTok))(concatStr(((between(charP("(")))(many1(charP("-+*/=:&|<>^"))))(charP(")"))));
...
var jaguarTokenP = many((or(stringP))((or(whitespaceP))((or(numP))((or(lineCommentP))((or(identP))((or(opIdentP))((or(opP))(symbolP))))))));
var tokenize = runLexer(jaguarTokenP);
var exports = {LexerState:LexerState,WsTok:WsTok,SymTok:SymTok,NumTok:NumTok,StrTok:StrTok,OpTok:OpTok,IdTok:IdTok,ComTok:ComTok,Token:Token,runLexer:runLexer,mkTok:mkTok,concatStr:concatStr,parseChar:parseChar,charP:charP,whitespaceP:whitespaceP,intP:intP,numP:numP,notCharP:notCharP,lineCommentP:lineCommentP,symbolP:symbolP,identP:identP,opIdentP:opIdentP,opP:opP,anyCharP:anyCharP,stringCharP:stringCharP,stringP:stringP,jaguarTokenP:jaguarTokenP,tokenize:tokenize}
return exports;})();
