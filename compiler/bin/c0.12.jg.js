...
var exports = {Just:Just,Nothing:Nothing,Pair:Pair,Left:Left,Right:Right,reverse:reverse,head:head,tail:tail,uniq:uniq,mergeSet:mergeSet,arr1:arr1,arr2:arr2,arr3:arr3,init:init,last:last,concatMap:concatMap,zip:zip,zipWithIndex2:zipWithIndex2,zipWithIndex:zipWithIndex,join:join,exists:exists,containsChar:containsChar,snd:snd,loop:loop,contains:contains,not:not,either:either,splitEither:splitEither,fst:fst,maybe:maybe}
return exports;})();
...
return ($concat(($concat(($concat(n))(" (")))((join((map(printPat))(ps)))(") ("))))(")")})($pm.$0,$pm.$1,$pm.$2)):(error("pattern match fail")))))})()};var printT = function(e){
return (function(){
var t = (function(){
...
return t})($pm.$0.$0,$pm.$1,$pm.$2)):(error("pattern match fail")))))))})();return printType(t)})()};var sameLine = function(as){
return function(bs){
return (concat(init(as)))((enqueue(($concat(last(as)))(head(bs))))(tail(bs)))}};var sameLine3 = function(a){
return function(b){
return function(c){
return (sameLine(a))((sameLine(b))(c))}}};var printParen = function(e){
...
var exports = {compileModule:compileModule,compileExpr:compileExpr}
return exports;})();
...
return arr1(v)})($pm.$0,$pm.$1)):(($pm.$tag==PConst.$tag)?((function(_,c){
return emptyArray})($pm.$0,$pm.$1)):(($pm.$tag==PData.$tag)?((function(_,n,ps){
return ((foldl(mergeSet))(emptyArray))((map(namesInPat))(ps))})($pm.$0,$pm.$1,$pm.$2)):(error("pattern match fail"))))})()};var freeVarsInPat = function(p){
return (function(){
var $pm = p;return ($pm.$tag==Pair.$tag)?((function(pat,e){
return (mergeSet((filter(function(v){
...
return function(t){
return (function(){
var freeTVarsInEnv = ((foldRecord(function(vs){
return function(_){
return function(t){
return (concat(vs))(freeTVars(t))}}}))(emptyArray))(env);var tvarsSubstitutingForEnvTVars = (function(){
var f = function(rs){
return function(v){
return function(t){
return (function(){
var $pm = (contains(v))(freeTVarsInEnv);return (!$pm)?((function(){
return rs})()):($pm?((function(){
return (concat(rs))(freeTVars(t))})()):(error("pattern match fail")))})()}}};return ((foldRecord(f))(emptyArray))(subs)})();var nonFree = (concat(freeTVarsInEnv))(tvarsSubstitutingForEnvTVars);var vs = (filter(function(v){
...
return function(e){
return (concat(((((dfs(($add(i))(1)))(pre))(g))((push(v))((concat(r))(visited))))(e)))(r)}};var es = (filter(function(v){
return not((contains(v))(visited))}))((get(v))(g));var r = ((foldr(visit))(emptyArray))(es);return (function(){
var $pm = pre;return $pm?((function(){
return (enqueue(v))(r)})()):((!$pm)?((function(){
return (push(v))(r)})()):(error("pattern match fail")))})()})()}}}}};var fullDfs = function(pre){
return function(g){
return (function(){
...
return (function(){
var $pm = pre;return (!$pm)?((function(){
return (concat(result))(((((dfs(0))(pre))(g))(result))(v))})()):($pm?((function(){
return (concat(((((dfs(0))(pre))(g))(result))(v)))(result)})()):(error("pattern match fail")))})()})()):(error("pattern match fail")))})()}}};var result = ((foldRecord(visit))(emptyArray))(g);return result})()}};var topSort = function(ccs){
return (function(){
var g2g = (function(){
var f = function(r){
return function(icc){
...
return ((set(rv))((mergeSet(res))((get(rv))(r))))(r)})()):(error("pattern match fail")))})()})()}}};var cg = ((foldRecord(addGraph))(empty))(g);var ord = (fullDfs(true))(cg);return reverse((map(function(i){
return (getIx(unsafeStringToInt(i)))(ccs)}))(ord))})()};var invertedG = (function(){
...
return (function(){
var cc = ((((dfs(0))(false))(ig))(emptyArray))(v);var ig2 = ((foldl(function(g){
return function(v){
return (del(v))((mapRecord(filter(function(w){
return ($neq(w))(v)})))(g))}}))(ig))(cc);return (Pair(ig2))((push(cc))(ccs))})()})()):(error("pattern match fail")))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}};var firstDfs = (fullDfs(false))(g);var ccs = snd(((foldr(assembleCc))((Pair(invertedG))(emptyArray)))(firstDfs));var result = topSort(ccs);return result})()};
...
return (function(){
var dsSubs = (map(unifyDef(env2)))(ds2);var subs2 = ((foldl(composeSubs))(subs))(dsSubs);var ds3 = (map(applySubsDef(subs2)))(ds2);var ds4 = (map((generalizeDef(env))(subs2)))(ds3);return (Pair((ICtx(subs2))(i)))(ds4)})()})($pm.$0.$0,$pm.$0.$1,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})()}}};
...
return ($and((contains(v))(ns)))(($neq(v))(n))}))(freeVars(e))))(g)})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}))(empty))(ds);var ccs = scc(g);return ((foldl(infer))((Pair(ctx))(emptyArray)))(ccs)})()}}};
...
var exports = {ICtx:ICtx,forall:forall,f1:f1,conType:conType,conTypes:conTypes,getType:getType,getTypedExports:getTypedExports,setType:setType,unrollDataConType:unrollDataConType,newTVar:newTVar,applySubs:applySubs,substitute:substitute,instantiate:instantiate,applySubsEnv:applySubsEnv,freeTVars:freeTVars,composeSubs:composeSubs,unify:unify,freeVars:freeVars,applySubsDef:applySubsDef,applySubsE:applySubsE,generalize:generalize,scc:scc,infer:infer,inferSccDefs:inferSccDefs,inferDefs:inferDefs,newCtx:newCtx,inferTypeModule:inferTypeModule,checkSubs:checkSubs,inferType:inferType}
return exports;})();
...
var findExports = getTypedExports;
...
var $pm = m;return ($pm.$tag==Module.$tag)?((function(_,is,ds,vs){
return (push("./builtins.js"))((map(importFileName))(is))})($pm.$0,$pm.$1,$pm.$2,$pm.$3)):(error("pattern match fail"))})()})()};
var transpileModule = compileModule;
...
return error(e)})($pm))})()};
var exports = {inferM:inferM,parseT:parseT,parseExports:parseExports,findExports:findExports,findImports:findImports,transpileModule:transpileModule,compile:compile,transpileExpr:transpileExpr}
return exports;})();
