...
var contains2 = function(x){
return function(xs){
return function(i){
return (function(){
var $pm = ($lt(i))(length(xs));return $pm?((function(){
return (function(){
var $pm = ($eq((get(i))(xs)))(x);return $pm?((function(){
return true})()):((!$pm)?((function(){
return ((contains2(x))(xs))(($add(i))(1))})()):(error("pattern match fail")))})()})()):((!$pm)?((function(){
return false})()):(error("pattern match fail")))})()}}};
var contains = function(x){
return function(xs){
return ((contains2(x))(xs))(0)}};
...
return (enqueue((Pair(n))((get(0))(xs))))((zipWithIndex2(($add(n))(1)))((slice(1))(xs)))})($pm))})()}};
...
return (function(){
var $pm = ($eq((get(0))(xs)))((get(1))(xs));return (!$pm)?((function(){
return (enqueue(head(xs)))(uniq(tail(xs)))})()):($pm?((function(){
return uniq(tail(xs))})()):(error("pattern match fail")))})()})()):(error("pattern match fail")))})()};
var exports = {Just:Just,Nothing:Nothing,Pair:Pair,Left:Left,Right:Right,maybe:maybe,fst:fst,snd:snd,either:either,splitEither:splitEither,not:not,contains2:contains2,contains:contains,exists:exists,join:join,zipWithIndex2:zipWithIndex2,zipWithIndex:zipWithIndex,zip:zip,concatMap:concatMap,head:head,tail:tail,last:last,init:init,arr1:arr1,arr2:arr2,arr3:arr3,mergeSet:mergeSet,uniq:uniq}
return exports;})();
...
return function(s){
return (function(){
var $pm = a(s);return ($pm.$tag==Success.$tag)?((function(a,s){
return (function(){
var $pm = b(s);return ($pm.$tag==Success.$tag)?((function(b,s){
return (Success((Pair(a))(b)))(s)})($pm.$0,$pm.$1)):((function(e){
return e})($pm))})()})($pm.$0,$pm.$1)):((function(e){
return e})($pm))})()}}};
...
return (Success(f(r)))(s)})($pm.$0,$pm.$1)):((function(e){
return e})($pm))})()}}};
...
return ((apply(enqueue(r)))(many(a)))(s)})($pm.$0,$pm.$1)):((function(e){
return e})($pm))})()}};
var sepBy1 = function(p){
return function(s){
return (apply(function(p){
return (function(){
var $pm = p;return ($pm.$tag==Pair.$tag)?((function(r,rs){
return (enqueue(r))(rs)})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}))((and(p))(many((precedes(s))(p))))}};
var opt = function(a){
return function(s){
return (function(){
var $pm = a(s);return ($pm.$tag==Success.$tag)?((function(r,s){
...
return ($concat(($concat(($concat(jsExprToParenString(xs)))("[")))(jsExprToString(i))))("]")})()):((function(i){
...
return (JSVar(n))(rewriteDCE(v))})($pm.$0,$pm.$1)):(($pm.$tag==JSExpr.$tag)?((function(l,r){
return (JSExpr(rewriteDCE(l)))(rewriteDCE(r))})($pm.$0,$pm.$1)):((function(s){
return s})($pm)))))})()};
...
return ($concat(($concat("("))(printType(t))))(")")};var printTypeInFun = function(t){
return (function(){
...
return printParen(t)})($pm.$0,$pm.$1.$0,$pm.$1.$1.$0,$pm.$1.$2,$pm.$2)):(($pm.$tag==TForall.$tag)?((function(_,v,a){
return printParen(t)})($pm.$0,$pm.$1,$pm.$2)):((function(_){
return printType(t)})($pm)))})()};var printSecondTypeInApp = function(t){
return (function(){
...
return v})($pm.$0,$pm.$1)):(($pm.$tag==TBot.$tag)?((function(_){
return "~bottom~"})($pm.$0)):(($pm.$tag==TUnknown.$tag)?((function(_){
...
return function(e){
return (function(){
var printParen = function(e){
return ((sameLine3(arr1("(")))(printExpr(e)))(arr1(")"))};var sameLine = function(as){
return function(bs){
return (concat(init(as)))((enqueue(($concat(last(as)))(head(bs))))(tail(bs)))}};var sameLine3 = function(a){
return function(b){
return function(c){
return (sameLine(a))((sameLine(b))(c))}}};var printCasePat = function(cp){
return (function(){
var $pm = cp;return ($pm.$tag==Pair.$tag)?((function(p,e){
return (enqueue(($concat(printPat(p)))(" ->")))(indent(printExpr(e)))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()};var printPat = function(p){
return (function(){
...
return ($concat(($concat(($concat(n))(" (")))((join((map(printPat))(ps)))(") ("))))(")")})($pm.$0,$pm.$1,$pm.$2)):(error("pattern match fail")))))})()};var printE = function(e){
return (function(){
...
return (concat((push("in"))((enqueue("let"))(indent((concatMap(printDef(typed)))(ds))))))(indent(printExpr(e)))})($pm.$0,$pm.$1,$pm.$2)):(error("pattern match fail"))))))))})()};var printT = function(e){
return (function(){
var t = (function(){
...
return t})($pm.$0.$0,$pm.$1,$pm.$2)):(error("pattern match fail")))))))})();return printType(t)})()};var printExpr = function(e){
return (function(){
...
var exports = {printType:printType,printExprTyped:printExprTyped,printDef:printDef,indent:indent,reallyPrintExpr:reallyPrintExpr}
return exports;})();
...
return (function(){
var $pm = p((get(i))(s));return (!$pm)?((function(){
return Error("parser failed")})()):($pm?((function(){
return (function(){
var $pm = (get(i))(s);return ("\n"==$pm)?((function(){
return (Success((get(i))(s)))((((LexerState(s))(($add(i))(1)))(($add(l))(1)))(0))})()):((function(x){
return (Success((get(i))(s)))((((LexerState(s))(($add(i))(1)))(l))(($add(c))(1)))})($pm))})()})()):(error("pattern match fail")))})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3)):(error("pattern match fail"))})()}};
var anyCharP = parseChar(function(c){
return true});
var charP = function(cs){
return parseChar(function(c){
return (contains(c))(cs)})};
var notCharP = function(cs){
return parseChar(function(c){
return not((contains(c))(cs))})};
var stringCharP = (or((apply(function(c){
...
return (JSVar(n))((JSIndex(requireExpr(f)))(JSString(n)))}))(ns)}};
...
return (function(){
var $pm = dc;return ($pm.$tag==DataCon.$tag)?((function(_,n,ts){
return ((arr3((JSVar(($add("$"))(n)))((JSFun(dataConFieldIds(ts)))((push(JSExpr(((JSBinOp("="))((JSIndex(JSRef("this")))(JSString("$tag"))))(JSString(n)))))((map(function(f){
return JSExpr(((JSBinOp("="))((JSIndex(JSRef("this")))(JSString(f))))(JSRef(f)))}))(dataConFieldIds(ts)))))))((JSVar(n))(((foldr(function(b){
return function(f){
return (JSFun(arr1(f)))(arr1(JSReturn(b)))}}))((JSNew(JSRef(($add("$"))(n))))((map(JSRef))(dataConFieldIds(ts)))))(dataConFieldIds(ts)))))((JSAssign((JSIndex(JSRef(n)))(JSString("$tag"))))(JSString(n)))})($pm.$0,$pm.$1,$pm.$2)):(error("pattern match fail"))})()};
...
return (function(){
var $pm = m;return ($pm.$tag==Module.$tag)?((function(_,is,ds,vs){
return (map(opName))(((foldl(mergeSet))(emptyArray))((map(function(p){
...
var $pm = (get(0))(ts);return ($pm.$tag==Token.$tag)?((function(t,v,l,c){
return c})($pm.$0,$pm.$1,$pm.$2,$pm.$3)):(error("pattern match fail"))})()))((push(0))(emptyArray))};
...
return p(mkParserState(filterWhitespaceAndComments(ts)))})($pm.$0,$pm.$1)):((function(e){
return e})($pm))})()}};
...
return (function(){
var $pm = (get(p))(ts);return ($pm.$tag==Token.$tag)?((function(t,v,l,c){
return (function(){
var $pm = ($lt(c))(ri);return $pm?((function(){
return Error("token not indented sufficiently")})()):((!$pm)?((function(){
return (function(){
var $pm = f((get(p))(ts));return ($pm.$tag==Nothing.$tag)?((function(){
...
return (function(){
var $pm = (get(($add(p))(1)))(ts);return ($pm.$tag==Token.$tag)?((function(t,v,l2,c){
return (function(){
...
var andIndent = function(a){
return function(b){
return function(s){
return (function(){
var $pm = s;return ($pm.$tag==ParserState.$tag)?((function(ts,p,li,ri){
return (function(){
var $pm = a(s);return (($pm.$tag==Success.$tag)&&($pm.$1.$tag==ParserState.$tag))?((function(a,ts,p2,li2,ri2){
return (function(){
var $pm = b((((ParserState(ts))(p2))(li2))(($add(li))(1)));return (($pm.$tag==Success.$tag)&&($pm.$1.$tag==ParserState.$tag))?((function(b,ts,p3,li3,ri3){
return (Success((Pair(a))(b)))((((ParserState(ts))(p3))(li3))(ri))})($pm.$0,$pm.$1.$0,$pm.$1.$1,$pm.$1.$2,$pm.$1.$3)):((function(e){
return e})($pm))})()})($pm.$0,$pm.$1.$0,$pm.$1.$1,$pm.$1.$2,$pm.$1.$3)):((function(e){
return e})($pm))})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3)):(error("pattern match fail"))})()}}};
...
var $pm = t;return (($pm.$tag==Token.$tag)&&($pm.$0.$tag==IdTok.$tag))?((function(v,i,c){
return (function(){
var $pm = (contains((get(0))(v)))(upperCaseLetters);return $pm?((function(){
...
return error("occurs check failed")})()):((!$pm)?((function(){
return ((set(n))(t))(empty)})()):(error("pattern match fail")))})()})($pm))})()}};var err = function(a){
return function(b){
return error(($concat(($concat(($concat("cannot unify "))(printType(a))))(" with ")))(printType(b)))}};return (function(){
...
return (err(a))(b)})($pm.$0)):(($pm.$tag==TBot.$tag)?((function(_){
return (err(a))(b)})($pm.$0)):(($pm.$tag==TApp.$tag)?((function(_,fa,xa){
return (function(){
...
return arr1(v)})($pm.$0,$pm.$1)):(($pm.$tag==TBot.$tag)?((function(_){
return emptyArray})($pm.$0)):(($pm.$tag==TUnknown.$tag)?((function(_){
...
return (function(){
var te2 = (applySubs(subs))(te);var bs2 = (mapRecord(applySubs(subs)))(bs);return (function(){
var $pm = ((infer((merge(env))(bs2)))((ICtx(subs))(i)))(e);return ($pm.$tag==Pair.$tag)?((function(ctx2,e2){
return (Pair(ctx2))((Pair(te2))((push((Pair(pat))(e2)))(ps)))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})()})($pm.$0.$0,$pm.$0.$1,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1.$0,$pm.$1.$1)):(error("pattern match fail"))})()}}};var inferPat = function(env){
return function(ctx){
return function(te){
return function(pat){
return (function(){
...
return (function(){
var usubs = (unify(te))(tv);var subs2 = (composeSubs(usubs))(subs);return (Pair((ICtx(subs2))(i)))(((set(v))((applySubs(subs2))(tv)))(empty))})()})($pm.$0.$0,$pm.$0.$1,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):((($pm.$tag==PConst.$tag)&&($pm.$1.$tag==CNum.$tag))?((function(_,n){
return (function(){
var $pm = ctx;return ($pm.$tag==ICtx.$tag)?((function(subs,i){
return (function(){
var usubs = (unify(te))((TConst(emptyAnn))("Number"));var subs2 = (composeSubs(usubs))(subs);return (Pair((ICtx(subs2))(i)))(empty)})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1.$0)):((($pm.$tag==PConst.$tag)&&($pm.$1.$tag==CStr.$tag))?((function(_,s){
return (function(){
var $pm = ctx;return ($pm.$tag==ICtx.$tag)?((function(subs,i){
return (function(){
var usubs = (unify(te))((TConst(emptyAnn))("String"));var subs2 = (composeSubs(usubs))(subs);return (Pair((ICtx(subs2))(i)))(empty)})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1.$0)):(($pm.$tag==PData.$tag)?((function(_,n,ps){
return (function(){
...
return (function(){
var usubs = (unify(te))((applySubs(subs))(dt));var subs2 = (composeSubs(usubs))(subs);return (Pair((ICtx(subs2))(i)))((mapRecord(applySubs(subs2)))(bs))})()})($pm.$0.$0,$pm.$0.$1,$pm.$1)):(error("pattern match fail"))})()})()):(error("pattern match fail")))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})()):(error("pattern match fail")))})()})($pm.$0,$pm.$1,$pm.$2)):(error("pattern match fail")))))})()}}}};var inferSubPat = function(env){
return function(cbs){
return function(pt){
return (function(){
...
return (Pair(ctx2))((merge(bs))(bs2))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}};return (function(){
...
return (function(){
var $pm = newTVar(ctx);return ($pm.$tag==Pair.$tag)?((function(ctx2,tv){
return (Pair(ctx2))(((set(n))(tv))(env))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}};var inferDef = function(env){
return function(cds){
return function(d){
return (function(){
...
return (function(){
var $pm = ((infer(env))(ctx))(e);return ($pm.$tag==Pair.$tag)?((function(ctx2,e2){
return (Pair(ctx2))((push((Pair(n))(e2)))(ds))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}};var unifyDef = function(env){
return function(d){
return (function(){
var $pm = d;return ($pm.$tag==Pair.$tag)?((function(n,e){
return (unify(getType(e)))((get(n))(env))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}};var generalizeDef = function(env){
return function(d){
return (function(){
var $pm = d;return ($pm.$tag==Pair.$tag)?((function(n,e){
return (Pair(n))((setType((generalize(env))(getType(e))))(e))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}};return (function(){
...
return (function(){
var dsSubs = (map(unifyDef(env2)))(ds2);var subs2 = ((foldl(composeSubs))(subs))(dsSubs);var ds3 = (map(applySubsDef(subs2)))(ds2);var ds4 = (map(generalizeDef(env2)))(ds3);return (Pair((ICtx(subs2))(i)))(ds4)})()})($pm.$0.$0,$pm.$0.$1,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})()}}};
var inferDefs = function(env){
return function(ctx){
return function(ds){
return (function(){
var ns = (map(fst))(ds);var g = ((foldl(function(g){
return function(d){
return (function(){
var $pm = d;return ($pm.$tag==Pair.$tag)?((function(n,e){
return ((set(n))((filter(function(v){
return (contains(v))(ns)}))(freeVars(e))))(g)})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}))(empty))(ds);var infer = function(cr){
return function(cc){
return (function(){
...
return (Pair(ctx2))((concat(rs))(ds))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}};return ((foldl(infer))((Pair(ctx))(emptyArray)))(scc(g))})()}}};
var generalize = function(env){
return function(t){
return (function(){
var vs = (filter(function(v){
return not((has(v))(env))}))(freeTVars(t));return ((foldr(function(t){
return function(v){
...
return function(e){
return (concat(((dfs(g))((concat(r))(visited)))(e)))(r)}};return ((foldr(visit))(arr1(v)))((filter(function(v){
return not((contains(v))(visited))}))((get(v))(g)))})()}}};var fullDfs = function(g){
return (function(){
...
return (concat(result))(((dfs(g))(result))(v))})()):(error("pattern match fail")))})()}}};return ((foldRecord(visit))(emptyArray))(g)})()};var invertedG = (function(){
...
return ($neq(w))(v)})))(g))}}))(ig))(cc);return (Pair(ig2))((push(cc))(ccs))})()})()):(error("pattern match fail")))})()})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}};var topSort = function(ccs){
return (function(){
var g2g = (function(){
var f = function(r){
return function(icc){
...
return ((set(rv))((mergeSet(res))((get(rv))(r))))(r)})()):(error("pattern match fail")))})()})()}}};var cg = ((foldRecord(addGraph))(empty))(g);return (map(function(i){
return (get(i))(ccs)}))(fullDfs(cg))})()};return topSort(snd(((foldr(assembleCc))((Pair(invertedG))(emptyArray)))(fullDfs(g))))})()};
...
var $pm = p;return ($pm.$tag==Pair.$tag)?((function(pat,e){
return (mergeSet((filter(function(v){
return not((contains(v))(namesInPat(pat)))}))(freeVarsInExpr(e))))(freeVarsInPData(pat))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()};var freeVarsInPData = function(p){
return (function(){
var $pm = p;return ($pm.$tag==PData.$tag)?((function(_,n,ps){
return ((foldl(mergeSet))(arr1(n)))((map(freeVarsInPData))(ps))})($pm.$0,$pm.$1,$pm.$2)):((function(_){
return emptyArray})($pm))})()};var namesInPat = function(p){
return (function(){
var $pm = p;return ($pm.$tag==PVar.$tag)?((function(_,v){
return arr1(v)})($pm.$0,$pm.$1)):(($pm.$tag==PConst.$tag)?((function(_,c){
return emptyArray})($pm.$0,$pm.$1)):(($pm.$tag==PData.$tag)?((function(_,n,ps){
return ((foldl(mergeSet))(emptyArray))((map(namesInPat))(ps))})($pm.$0,$pm.$1,$pm.$2)):(error("pattern match fail"))))})()};return (function(){
var $pm = e;return ($pm.$tag==Var.$tag)?((function(_,v){
return arr1(v)})($pm.$0,$pm.$1)):(($pm.$tag==Const.$tag)?((function(_,c){
return emptyArray})($pm.$0,$pm.$1)):(($pm.$tag==App.$tag)?((function(_,f,x){
...
return error("import type not supported in type inference")})($pm)))})()}};var addTypes = function(env){
return function(dt){
return ((foldl(function(env){
return function(c){
return (function(){
var $pm = c;return ($pm.$tag==Pair.$tag)?((function(n,t){
return ((set(n))(t))(env)})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}))(env))((concatMap(conTypes))(dt))}};return (function(){
var $pm = m;return ($pm.$tag==Module.$tag)?((function(ann,is,ts,ds){
return (function(){
var env = ((foldl(addImports))(builtinTypes))(is);var env2 = ((foldl(addTypes))(env))(ts);var _ = debug(env2);var ds2 = snd(((inferDefs(env2))(newCtx))(ds));return (((Module(ann))(is))(ts))(ds2)})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3)):(error("pattern match fail"))})()})()}};
...
return (Pair(n))(((TForall(emptyAnn))(tvs))(((foldl(f1))(((foldl(function(r){
return function(v){
...
return (Pair(fst(d)))(getType(snd(d)))}))(ds);return ((foldl(function(es){
return function(e){
return ((set(fst(e)))(snd(e)))(es)}}))(empty))((concat(et))(ed))})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3)):(error("pattern match fail"))})()};
var builtinTypes = (function(){
var num = (TConst(emptyAnn))("Number");var str = (TConst(emptyAnn))("String");var bool = (TConst(emptyAnn))("Bool");var rec = function(a){
return ((TApp(emptyAnn))((TConst(emptyAnn))("Record")))(a)};var prec = function(n){
return rec(v(n))};var arr = function(a){
return ((TApp(emptyAnn))((TConst(emptyAnn))("Array")))(a)};var parr = function(n){
return arr(v(n))};var fa = function(n){
return function(t){
return ((TForall(emptyAnn))(n))(t)}};var v = function(n){
return (TVar(emptyAnn))(n)};var f2 = function(a){
return function(b){
return function(c){
return (f1(a))((f1(b))(c))}}};var f3 = function(a){
return function(b){
return function(c){
return function(d){
return (f1(a))(((f2(b))(c))(d))}}}};return ((set("+"))(((f2(num))(num))(num)))(((set("-"))(((f2(num))(num))(num)))(((set("*"))(((f2(num))(num))(num)))(((set("<"))(((f2(num))(num))(bool)))(((set(">"))(((f2(num))(num))(bool)))(((set("=="))((fa("a"))(((f2(v("a")))(v("a")))(bool))))(((set("/="))((fa("a"))(((f2(v("a")))(v("a")))(bool))))(((set("&&"))(((f2(bool))(bool))(bool)))(((set("||"))(((f2(bool))(bool))(bool)))(((set("++"))(((f2(str))(str))(str)))(((set("empty"))((fa("a"))(prec("a"))))(((set("get"))((fa("a"))(((f2(str))(prec("a")))(v("a")))))(((set("del"))((fa("a"))(((f2(str))(prec("a")))(prec("a")))))(((set("set"))((fa("a"))((((f3(str))(v("a")))(prec("a")))(prec("a")))))(((set("keys"))((fa("a"))((f1(prec("a")))(arr(str)))))(((set("has"))((fa("a"))(((f2(str))(prec("a")))(bool))))(((set("mapRecord"))((fa("a"))((fa("b"))(((f2((f1(v("a")))(v("b"))))(prec("a")))(prec("b"))))))(((set("foldRecord"))((fa("a"))((fa("b"))((((f3(((f3(v("b")))(str))(v("a"))))(v("b")))(prec("a")))(v("b"))))))(((set("merge"))((fa("a"))(((f2(prec("a")))(prec("a")))(prec("a")))))(((set("unsafeStringToInt"))((f1(str))(num)))(((set("match"))(((f2(str))(str))(str)))(((set("drop"))(((f2(num))(str))(str)))(((set("length"))((fa("a"))((f1(v("a")))(num))))(((set("emptyArray"))((fa("a"))(parr("a"))))(((set("push"))((fa("a"))(((f2(v("a")))(parr("a")))(parr("a")))))(((set("enqueue"))((fa("a"))(((f2(v("a")))(parr("a")))(parr("a")))))(empty))))))))))))))))))))))))))})();
var exports = {ICtx:ICtx,f1:f1,newTVar:newTVar,newCtx:newCtx,instantiate:instantiate,substitute:substitute,applySubs:applySubs,applySubsEnv:applySubsEnv,composeSubs:composeSubs,unify:unify,freeTVars:freeTVars,infer:infer,inferType:inferType,inferSccDefs:inferSccDefs,inferDefs:inferDefs,generalize:generalize,unrollDataConType:unrollDataConType,applySubsDef:applySubsDef,applySubsE:applySubsE,setType:setType,getType:getType,scc:scc,freeVars:freeVars,inferTypeModule:inferTypeModule,conTypes:conTypes,conType:conType,getTypedExports:getTypedExports,builtinTypes:builtinTypes}
return exports;})();
cache["compiler/compiler.jg"] = (function() {var $eq = (_require("./builtins.js")).$eq;
var $concat = (_require("./builtins.js")).$concat;
var get = (_require("./builtins.js")).get;
var mapRecord = (_require("./builtins.js")).mapRecord;
var merge = (_require("./builtins.js")).merge;
...
var inferType = (_require("//compiler/typer.jg")).inferType;
var builtinTypes = (_require("//compiler/typer.jg")).builtinTypes;
var newCtx = (_require("//compiler/typer.jg")).newCtx;
var scc = (_require("//compiler/typer.jg")).scc;
...
var transpileExpr = function(s){
return (function(){
var $pm = parseExpr(s);return ($pm.$tag==Success.$tag)?((function(e,ps){
return compileExpr(e)})($pm.$0,$pm.$1)):((function(e){
return error(e)})($pm))})()};
var transpileModule = function(importSymbols){
return function(s){
return (function(){
...
return (compileModule(importSymbols))(m)})()):((!$pm)?((function(){
return error(($concat("failed to parse all tokens, stopped at "))(jsonStringify((get(p))(ts))))})()):(error("pattern match fail")))})()})($pm.$0,$pm.$1.$0,$pm.$1.$1,$pm.$1.$2,$pm.$1.$3)):((function(e){
return error(e)})($pm))})()}};
var findImports = function(s){
return (function(){
...
var $pm = parseModule(s);return (($pm.$tag==Success.$tag)&&($pm.$0.$tag==Module.$tag))?((function(_,is,ds,vs,ps){
return (push("./builtins.js"))((map(importFileName))(is))})($pm.$0.$0,$pm.$0.$1,$pm.$0.$2,$pm.$0.$3,$pm.$1)):((function(e){
return error(e)})($pm))})()})()};
var findExports = function(s){
return (function(){
var $pm = parseModule(s);return ($pm.$tag==Success.$tag)?((function(m,ps){
return getTypedExports(m)})($pm.$0,$pm.$1)):((function(e){
return error(e)})($pm))})()};
...
return error(e)})($pm))})()};
var parseExports = mapRecord(parseT);
var parseE = function(s){
return (function(){
var $pm = parseExpr(s);return (($pm.$tag==Success.$tag)&&($pm.$1.$tag==ParserState.$tag))?((function(e,ts,p,li,ri){
return (function(){
var $pm = ($eq(p))(length(ts));return $pm?((function(){
return e})()):((!$pm)?((function(){
return error(($concat("failed to parse all tokens, stopped at "))(jsonStringify((get(p))(ts))))})()):(error("pattern match fail")))})()})($pm.$0,$pm.$1.$0,$pm.$1.$1,$pm.$1.$2,$pm.$1.$3)):((function(e){
return error(e)})($pm))})()};
var printT = printType;
var printE = reallyPrintExpr;
var inferT = function(env){
return function(e){
return ((inferType((merge(builtinTypes))(env)))(newCtx))(e)}};
var mscc = scc;
var inferM = inferTypeModule;
var exports = {transpileExpr:transpileExpr,transpileModule:transpileModule,findImports:findImports,findExports:findExports,parseT:parseT,parseExports:parseExports,parseE:parseE,printT:printT,printE:printE,inferT:inferT,mscc:mscc,inferM:inferM}
return exports;})();
