...
var exports = {Just:Just,Nothing:Nothing,Pair:Pair,Left:Left,Right:Right,toRecord:toRecord,reverse:reverse,tail:tail,head:head,uniq:uniq,mergeSet:mergeSet,arr1:arr1,arr2:arr2,arr3:arr3,arr4:arr4,init:init,last:last,concatMap:concatMap,zip:zip,zipWithIndex2:zipWithIndex2,zipWithIndex:zipWithIndex,join:join,exists:exists,containsChar:containsChar,snd:snd,loop:loop,find:find,contains:contains,not:not,either:either,splitEither:splitEither,fst:fst,justOr:justOr,maybe:maybe}
return exports;})();
...
var env2 = (function(){
var $pm = i;return ($pm.$tag==ImportAll.$tag)?((function(f){
return (addBindings(bs))(env)})($pm.$1)):(($pm.$tag==ImportOpen.$tag)?((function(f,ns){
return ((foldl(function(env){
return function(n){
return ((addBinding(n))((get(n))(bs)))(env)}}))(env))(ns)})($pm.$1,$pm.$2)):((function(){
return error("import type not supported in type inference")})()))})();var env3 = ((foldl(addClass))(env2))(cs);var env4 = ((foldl(function(env){
return function(i){
...
return (function(){
var env = emptyEnv;var env2 = ((foldl(addImports))(env))((enqueue((ImportAll(emptyAnn))("./builtins.js")))(is));var env3 = ((foldl(addTypes))(env2))(ts);var env4 = ((foldl(addClass))(env3))(cs);var env5 = ((foldl(addIns))(env4))(ins);var ds2 = snd(((inferDefs(env5))(newCtx))(ds));var ds3 = (map(checkForUnsatisfiedBounds))(ds2);var env6 = ((foldl(function(env){
return function(d){
return (function(){
var $pm = d;return ($pm.$tag==Pair.$tag)?((function(n,e){
return ((addBinding(n))(getType(e)))(env)})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}))(env5))(ds3);var ins2 = (map((inferInstance(env6))(cs)))(ins);return (((((Module(ann))(is))(ts))(cs))(ins))(ds3)})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3,$pm.$4,$pm.$5)):(error("pattern match fail"))})()})()}};
...
return error("failed to find satisfying instance")})())})()})($pm.$1)):(error("pattern match fail"))})()}};var requiredInstances = function(tv){
return function(td){
return (function(){
...
return (function(){
var name = className2(c);var rewrite = function(b){
return (function(){
var $pm = b;return ($pm.$tag==Pair.$tag)?((function(n,t){
return (Pair(n))((setType(t))(((Lam(emptyAnn))("x"))(((Case(emptyAnn))((Var(emptyAnn))("x")))(arr1((Pair(((PData(emptyAnn))(name))(arr1((PVar(emptyAnn))(n)))))((Var(emptyAnn))(n)))))))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()};return (map(rewrite))(classToBindings(c))})()};
...
var rewriteInstance = function(ix){
return function(i){
return (function(){
var $pm = i;return ($pm.$tag==Instance.$tag)?((function(n,bs){
return (function(){
var as = (map(snd))(sort(bs));var name = (instanceName(ix))(i);return (Pair(name))(((foldl(App(emptyAnn)))((Var(emptyAnn))(className(n))))(as))})()})($pm.$1,$pm.$3)):(error("pattern match fail"))})()}};
...
return ((foldl(function(env){
return function(n){
return ((set(n))((get(n))(bs)))(env)}}))(env))(ns)})($pm.$1,$pm.$2)):((function(){
...
return (function(){
var availableInstances = (map(function(p){
return (function(){
var $pm = p;return ($pm.$tag==Pair.$tag)?((function(ix,i){
return (Pair((instanceName(ix))(i)))(instanceToTypeBound(i))})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}))(zipWithIndex(ins));var dataFuns = (concatMap(conTypes))(dt);var classFuns = (concatMap(rewriteClassToFun))(cs);var instancesAsDefs = (map(function(p){
return (function(){
var $pm = p;return ($pm.$tag==Pair.$tag)?((function(n,i){
return (rewriteInstance(n))(i)})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}))(zipWithIndex(ins));var env = ((foldl(function(env){
return function(b){
return (function(){
var $pm = b;return ($pm.$tag==Pair.$tag)?((function(v,e){
return ((set(v))(getType(e)))(env)})($pm.$0,$pm.$1)):(error("pattern match fail"))})()}}))((importsToTypeEnv(ms))(is)))((concat(classFuns))((concat(instancesAsDefs))(ds)));var env2 = (merge(env))(toRecord(dataFuns));var ds2 = (map(function(d){
return (Pair(fst(d)))(((rewriteExpr(availableInstances))(env2))(snd(d)))}))(ds);var classesAsData = (map(rewriteClassToData))(cs);return (((((Module(ann))(is))((concat(dt))(classesAsData)))(cs))(ins))((concat(classFuns))((concat(instancesAsDefs))(ds2)))})()})($pm.$0,$pm.$1,$pm.$2,$pm.$3,$pm.$4,$pm.$5)):(error("pattern match fail"))})()}};
var exports = {S:S,instanceNameFromBound:instanceNameFromBound,getEnv:getEnv,breakableDownAndUpWithEnv:breakableDownAndUpWithEnv,addPrefix:addPrefix,setEnv:setEnv,rewriteExpr:rewriteExpr,className:className,className2:className2,rewriteClassToFun:rewriteClassToFun,rewriteClassToData:rewriteClassToData,instanceName:instanceName,rewriteInstance:rewriteInstance,importsToTypeEnv:importsToTypeEnv,declassModule:declassModule}
return exports;})();
...
return function(i){
return (function(){
var $pm = i;return ($pm.$tag==ImportClosed.$tag)?((function(f,n){
return (function(){
var $pm = (contains(n))(freeVars);return $pm?((function(){
return arr1((JSVar(n))(requireExpr(f)))})()):((!$pm)?((function(){
return emptyArray})()):(error("pattern match fail")))})()})($pm.$1,$pm.$2)):(($pm.$tag==ImportOpen.$tag)?((function(f,ns){
return (buildImports(f))((filter(function(n){
return (contains(n))(freeVars)}))(ns))})($pm.$1,$pm.$2)):(($pm.$tag==ImportAll.$tag)?((function(f){
return (function(){
var bs = (function(){
var $pm = (get(f))(importSymbols);return ($pm.$tag==ModuleInterface.$tag)?((function(bs){
return bs})($pm.$0)):(error("pattern match fail"))})();return (buildImports(f))((filter(function(n){
return (contains(n))(freeVars)}))(keys(bs)))})()})($pm.$1)):(error("pattern match fail"))))})()}}};
...
return arr1(v)})($pm.$1)):(($pm.$tag==PConst.$tag)?((function(c){
return emptyArray})($pm.$1)):(($pm.$tag==PData.$tag)?((function(n,ps){
return ((foldl(mergeSet))(emptyArray))((map(namesInPat))(ps))})($pm.$1,$pm.$2)):(error("pattern match fail"))))})()};
var freeVarsInPData = function(p){
return (function(){
var $pm = p;return ($pm.$tag==PData.$tag)?((function(n,ps){
return ((foldl(mergeSet))(arr1(n)))((map(freeVarsInPData))(ps))})($pm.$1,$pm.$2)):((function(p){
...
return arr1(v)})($pm.$1)):(($pm.$tag==Const.$tag)?((function(c){
return emptyArray})($pm.$1)):(($pm.$tag==App.$tag)?((function(f,x){
return (mergeSet(freeVarsInExpr(f)))(freeVarsInExpr(x))})($pm.$1,$pm.$2)):(($pm.$tag==Lam.$tag)?((function(p,b){
return (filter(function(v){
return ($neq(v))(p)}))(freeVarsInExpr(b))})($pm.$1,$pm.$2)):(($pm.$tag==Case.$tag)?((function(e,ps){
return ((foldl(mergeSet))(freeVarsInExpr(e)))((map(freeVarsInPat))(ps))})($pm.$1,$pm.$2)):(($pm.$tag==Let.$tag)?((function(ds,e){
return (filter(function(v){
return not((contains(v))((map(fst))(ds)))}))(((foldl(mergeSet))(freeVarsInExpr(e)))((map(function(d){
return freeVarsInExpr(snd(d))}))(ds)))})($pm.$1,$pm.$2)):(error("pattern match fail")))))))})()};
...
return freeVarsInExpr(snd(p))}))(vs))})($pm.$1,$pm.$2,$pm.$5)):(error("pattern match fail"))})()};
var moduleToJs = function(importSymbols){
return function(m){
return (function(){
var $pm = m;return ($pm.$tag==Module.$tag)?((function(is,ds,cs,ins,vs){
return (function(){
var exportDef = (JSVar("exports"))(exportObject(m));var defs = (map(defToJs))(vs);var dataDefs = (concatMap(dataToJs))(ds);var imports = (concatMap((importToJs(importSymbols))(freeVarsInModule(m))))((enqueue((ImportAll(emptyAnn))("./builtins.js")))(is));return (push(exportDef))((concat(imports))((concat(dataDefs))(defs)))})()})($pm.$1,$pm.$2,$pm.$3,$pm.$4,$pm.$5)):(error("pattern match fail"))})()}};
...
var reserved = (push("class"))((push("where"))((push("instance"))((push("let"))((push("in"))((push("from"))((push("import"))((push("case"))((push("of"))((push("data"))(emptyArray))))))))));
...
return (function(){
var m = (get(n))(compiled);var typed = (inferTypeModule(exports))(m);var declassed = (declassModule(exports))(typed);var transpiled = (function(){
