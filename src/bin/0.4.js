...
var importToJS = ixssi => ($pm => {if(($pm instanceof $Pair) && (true) && ($pm.$1 instanceof $Pair) && (true) && (true)){ return ((ix,ss,i) => ($pm => {if(($pm instanceof $ImportClosed) && (true) && (true)){ return ((f,n) => (($concat)((($concat)((($concat)((($concat)("var "))(n)))(" = _require('")))(f)))("');"))($pm.$0,$pm.$1)} else if(($pm instanceof $ImportOpen) && (true) && (true)){ return ((f,ns) => (($concat)((($concat)((($concat)((($concat)((($concat)("var $import$"))(ix)))(" = _require('")))(f)))("');\n")))(((join)(((map)(n => (($concat)((($concat)((($concat)((($concat)((($concat)((($concat)("var "))(n)))(" = $import$")))(ix)))(".")))(n)))(";")))(ns)))("\n")))($pm.$0,$pm.$1)} else if(($pm instanceof $ImportAll) && (true)){ return ((f) => (($concat)((($concat)((($concat)((($concat)((($concat)("var $import$"))(ix)))(" = _require('")))(f)))("');\n")))(((join)(((map)(n => (($concat)((($concat)((($concat)((($concat)((($concat)((($concat)("var "))(n)))(" = $import$")))(ix)))(".")))(n)))(";")))(ss)))("\n")))($pm.$0)} else { throw 'pattern match fail' }})(i))($pm.$0,$pm.$1.$0,$pm.$1.$1)} else { throw 'pattern match fail' }})(ixssi);
var builtinsImport = (ImportAll)("../builtins.js");
